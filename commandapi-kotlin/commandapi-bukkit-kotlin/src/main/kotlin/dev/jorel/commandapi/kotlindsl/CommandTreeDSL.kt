...
inline fun CommandTree.potionEffectArgument(nodeName: String, optional: Boolean = false, block: Argument<*>.() -> Unit = {}): CommandTree = addArgument(PotionEffectArgument(nodeName), optional, block)
...
inline fun Argument<*>.potionEffectArgument(nodeName: String, optional: Boolean = false, block: Argument<*>.() -> Unit = {}): Argument<*> = addArgument(PotionEffectArgument(nodeName), optional, block)
